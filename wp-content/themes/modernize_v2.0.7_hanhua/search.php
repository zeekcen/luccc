				...
				if( have_posts() ){
					...
					if( $gdl_admin_translator == 'enable' ){
						$translator_not_found = get_option(THEME_SHORT_NAME.'_search_not_found', 
							'抱歉，没有符合您搜索条件的结果。请尝试一些不同的关键字。');
					}else{
						$translator_not_found = __('抱歉，没有符合您搜索条件的结果。' . 
							' 请尝试一些不同的关键字。','gdl_front_end');		
					}		
					
					echo '<div class="sixteen columns mt30">';
					echo '<h1 class="gdl-page-title gdl-divider gdl-title title-color">' . __('搜索','gdl_front_end') . '</h1>';
