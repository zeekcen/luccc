<?php
	...
	*/
	...
	function create_portfolio() {
		...
		$labels = array(
			'name' => _x('组合', '组合通常名称', 'gdl_back_office'),
			'singular_name' => _x('组合项目', '组合项目别称', 'gdl_back_office'),
			'add_new' => _x('添加', '添加新的组合项目名称', 'gdl_back_office'),
			'add_new_item' => __('添加新的组合项目', 'gdl_back_office'),
			'edit_item' => __('编辑组合项目', 'gdl_back_office'),
			'new_item' => __('新组合项目', 'gdl_back_office'),
			'view_item' => __('浏览组合项目', 'gdl_back_office'),
			'search_items' => __('搜索组合项目', 'gdl_back_office'),
	...
	function show_portfolio_column($columns){
		$columns = array(
			...
			"title" => "标题",
			"author" => "作者",
			"portfolio-tags" => "组合项目标签",
			"portfolio-category" => "组合项目分类",
			"date" => "日期");
		return $columns;
	}
	...
	$portfolio_meta_boxes = array(	
		...
		"Sidebar Template" => array(
			'title'=> __('侧边栏模板', 'gdl_back_office'), 
		...
		"Author Infomation" => array(
			'title'=> __('显示作者信息', 'gdl_back_office'),
		...
		"Social Sharing" => array(
			'title'=> __('社交网络分享', 'gdl_back_office'),
		...
		"Thumbnail Types" => array(
			'title'=> __('缩略图类型', 'gdl_back_office'),
		...
		"Thumbnail Image Type" => array(
			'title'=> __('特色图像链接类型', 'gdl_back_office'),
	...
	function add_portfolio_option(){	
		...
		add_meta_box('portfolio-option', __('组合项目选项','gdl_back_office'), 'add_portfolio_option_element',
