		...
		?>
			...
			<div class="meta-body">
				...
				<div class="meta-input">	
					...
					<input class="upload_image_button_meta" type="button" value="上传" />
				</div>
							...
							<ul>
								<li id="default" class="default">
									...
									<div id="slider-detail" class="slider-detail"> 	
										<div class="meta-title meta-detail-title"><?php _e('滑块标题', 'gdl_back_office'); ?></div> 
										<div class="meta-detail-input meta-input"><input type="text" id='<?php echo $name['title']; ?>' /></div><br class="clear">
										<hr class="separator">
										<div class="meta-title meta-detail-title"><?php _e('滑块字幕', 'gdl_back_office'); ?></div>
										...
										<div class="meta-input meta-detail-input">
											...
											<div class="meta-title meta-detail-title ml0 mt5" rel="video"><?php _e('视频网址 (仅适用于 ANYTHING 滑块)', 'gdl_back_office'); ?></div> 
													...
													<div class="meta-input meta-detail-input">
														<div class="combobox">
															...
															<select name='<?php echo $name['linktype']; ?>[]' id='<?php echo $name['linktype']; ?>' >
																...
																<option <?php echo ($linktype_val == 'Link to Video')?  "selected" : ''; ?>>链接到视频</option>
															</select>
														</div>
														<div class="meta-title meta-detail-title ml0 mt5" rel="url"><?php _e('网址', 'gdl_back_office'); ?></div> 
														<div class="meta-title meta-detail-title ml0 mt5" rel="video"><?php _e('视频网址 (仅适用于 ANYTHING 滑块)', 'gdl_back_office'); ?></div> 
