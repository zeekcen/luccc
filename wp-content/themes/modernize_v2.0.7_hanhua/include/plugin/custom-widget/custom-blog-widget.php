...
class Recent_Post extends WP_Widget {
	...
	function Recent_Post() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recentpost-widget', 'description' => __('显示最新文章小工具。', 'gdl_back_office') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'recentpost-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'recentpost-widget', __('最新文章 (Goodlayers)', 'gdl_back_office'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('最新文章', 'gdl_back_office'), 'post_cat' => __('所有', 'gdl_back_office'), 'show_num' => '3');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'post_cat' ); ?>"><?php _e('分类 :', 'gdl_back_office'); ?></label>		
