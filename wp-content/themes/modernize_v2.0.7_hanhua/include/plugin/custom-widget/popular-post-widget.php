...
class Popular_Post extends WP_Widget {
	...
	function  Popular_Post() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'popularpost-widget', 'description' => __('显示热评文章小工具。', 'gdl_back_office') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'popularpost-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'popularpost-widget', __('最热文章 (Goodlayers)', 'gdl_back_office'), $widget_ops, $control_ops );
	}
					...
					<div class="recent-post-widget-context">
						...
						<div class="recent-post-widget-comment-num post-info-color">
							<?php 
								...
								if( $comments_num > 1 ){ 
									$output = str_replace( '%', number_format_i18n($comments_num), __('% 条评论') ); 
									echo $output; 
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('最热文章', 'gdl_back_office'), 'post_cat' => __('0', 'gdl_back_office'), 'show_num' => '3');
