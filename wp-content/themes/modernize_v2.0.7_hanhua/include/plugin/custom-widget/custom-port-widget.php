...
class Recent_Port extends WP_Widget {
	...
	function Recent_Port() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recentport-widget', 'description' => __('显示最新组合小工具。', 'gdl_back_office') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'recentport-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'recentport-widget', __('最新组合 样式1 (Goodlayers)', 'gdl_back_office'), $widget_ops, $control_ops );
	}
