...
class Recent_Port2 extends WP_Widget {
	...
	function Recent_Port2() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recentport-widget2', 'description' => __('显示最新组合小工具。', 'gdl_back_office') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'recentport-widget2' );

		/* Create the widget. */
		$this->WP_Widget( 'recentport-widget2', __('最新组合 样式2 (Goodlayers)', 'gdl_back_office'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('最新组合', 'gdl_back_office'), 'port_cat' => __('所有', 'gdl_back_office'), 'show_num' => '3');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'port_cat' ); ?>"><?php _e('分类 :', 'gdl_back_office'); ?></label>		
