...
class Twitter extends WP_Widget {
	...
	function Twitter() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'twitter-widget', 'description' => __('显示 Twitter 帖子小工具。', 'gdl_back_office') );
...
<?php
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Twitter', 'gdl_back_office'), 'twitter_username' => '', 'show_num' => '5');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_username' ); ?>"><?php _e('Twitter 用户名', 'gdl_back_office'); ?></label>
