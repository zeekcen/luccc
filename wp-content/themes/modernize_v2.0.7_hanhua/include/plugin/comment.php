		...
		switch ( $comment->comment_type ) :
			...
			?>
				<li class="post pingback">	
					<p>
						<?php _e( '引用:', 'gdl_back_office'); ?>
						<?php comment_author_link(); ?>
						<?php edit_comment_link( __('(编辑)', 'gdl_back_office'), ' ' ); ?>
					</p>
			<?php
				break;
					...
					<div class="comment-body gdl-divider">
						...
						<div class="comment-context">
							<div class="comment-head">
								...
								<span class="comment-date post-info-color"> <?php _e('','gdl_front_end'); ?> <?php echo get_comment_time();?></span>
